...
using RouletteAPI.ExceptionHandlerMiddleware;
using RoulettePlatform.Classes;
using RoulettePlatform.DependancyInjection;
...
namespace RouletteAPI
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IBettingInterface, GetBettingResults>();
            services.AddScoped<IHistoryInterface, History>();
